      ...
      <Container className="flex flex-col items-center md:flex-row max-w-7xl md:gap-x-8 mx-auto px-8">
        ...
        <div className="flex items-center w-full mt-12 md:mt-0">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-semibold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              Định hình tương lai số hóa cùng TPD
            </h1>
            <p className="mt-6 mb-12 text-xl leading-normal text-gray-500 dark:text-gray-300">
